        ...
        <StyledMapContainer>
            <header>
                <div className="page-content">
                    ...
                    <p>EmergencyProfile with any refugee organizations near you. Click the icon to get more information.</p>
                </div>
            </header>
            {
                EmergencyProfilePlacesStatus ? (
                    <ReactMapGL 
                        {...viewport} 
                    ...
                    >
                        ...
                        {
                            EmergencyProfilePlaces.response.venues.map(org => (
                                <Marker
                                    key={org.id}
